<?php namespace JerryLib\Model;
	...
	class CommonModel extends Model {
         ...
         * 更新(数组形式)
         */
        public function update_arr($table = null, $arr = array(), $where = array()) {
            $set_arr = $where_arr = $params = array();
            ...
            $this->sql = "update $table set $set_str where $where_str";
            $this->params = $params;
