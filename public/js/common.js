 ...
 */
    ...
    $(document).ready(function() {
        ...
        $("#user_form input").focus(function() {
            ...
            var content = $(this).parent("div").find(".content");
            var icontips = $(this).parent("div").find(".icontips");
            icontips.removeClass("icontips1 icontips2 icontips3 icontips4").addClass("icontips1");
            if(idname=="verify" || idname=="logo_file") { //如果是获取验证码
            ...
            switch(idname) {
                ...
                case "telephones":
                    ...
                    break;
                case "rulename":
                    content.html("权限地址,以‘/’隔开!");
                    break;
                case "remark":
                    content.html("权限名称,30个字以内!");
                    break;
                case "sort":
                    content.html("排序,必须是数字!");
                    break;
                case "goods_name":
                    content.html("商品名称,30个字以内!");
                    break;
                case "price":
                    content.html("商品价格,数字(斤)!");
                    break;
                case "zk_price":
                    content.html("折扣价格,数字(斤)!");
                    break;
                case "goods_desc":
                    content.html("商品描述,50个字以内!");
                    break;
                case "viprate":
                    content.html("会员折扣,数字!");
                    break;
                case "vipname":
                    content.html("会员名称,10个字以内!");
                    break;
            }
        }).blur(function() {
            var errortext = '';
            ...
            switch(idname) {
                ...
                case "qq":
                    ...
                    break;
                case "company":
                    if(!check_text(value)) errortext = "公司格式不正确!";
                    break;
                case "weixin":
                ...
                case "verify":
                    ...
                    break;
                case "sort":
                    if(isNaN(value)) errortext = "排序必须输入数字!";
                    break;
                case "price":
                    if(isNaN(value)) errortext = "价格必须输入数字!";
                    break;
                case "zk_price":
                    if(isNaN(value)) errortext = "价格必须输入数字!";
                    break;
                case "viprate":
                    if(isNaN(value)) errortext = "折扣必须输入数字!";
                    break;
            }
            if(errortext == '') {
