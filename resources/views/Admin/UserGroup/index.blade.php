                    ...
                    <tbody class="main">
                        <?php
                            foreach ($data as $key => $value) {
                                ...
                                $enable = "<a onclick=\"return confirm('请确认');\" href='".URL('Admin/UserGroup/enable?id='.$value['id'].'&status='.$enable_stats)."'>$enable_str</a>";
                                $delete = "<a onclick=\"return confirm('请确认');\" href='".URL('Admin/UserGroup/delete?id='.$value['id'])."'>删除</a>";
